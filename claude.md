...
- **Site name:** Gadgets World
- **Domain:** gadgets.globalinfonest.com (Netlify)
- **GitHub repo:** `kaushik-jagani/gadgets-world-blog` (private)
- **Purpose:** Gadgets blog — reviews, comparisons, buying guides
...
- **Analytics:** Google Analytics `G-DBPV8Y3PKE` — on EVERY HTML page
...
| Blog listing | `/blog` | `/pages/blog-list.html` | Gadgets (active) |
| Blog post | `/blog/[slug]` | `/pages/blog-post.html` | Gadgets (active) |
...
{
  "slug": "post-slug-here",
  "url": "https://gadgets.globalinfonest.com/blog/post-slug-here",
  "title": "Post Title",
  "author": "Author Name",
  "date": "2026-04-18",
  "readTime": "8 min read",
  ...
  "openGraph": {
    ...
    "url": "https://gadgets.globalinfonest.com/blog/slug",
    "site_name": "Gadgets World",
    "image": "https://...",
    "locale": "en_US"
  },
...
| ID | Slug |
|----|------|
| 1  | motorola-smartphones-2026-complete-guide |
...
- **Nav links:** Home → `/`, Gadgets → `/blog`, About → `/about`, Contact → `/contact`
